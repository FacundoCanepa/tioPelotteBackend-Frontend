...
<div className="text-center mb-6">
  ...
  <h4 className="text-lg font-garamond italic text-stone-600 mt-2 border-b-2 border-dashed border-black/50 md:border-none inline-block ">
...
export default PostresProducts;
